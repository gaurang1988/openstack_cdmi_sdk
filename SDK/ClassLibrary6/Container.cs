...
{ /// <summary>
    ...
    public class Container
    {
        ...
        public Boolean createChildContainer(String childName, String metadataKey,String metadataValue)
        {
            try
            {
                byte[] buf = Encoding.UTF8.GetBytes(
        ...
        /// <returns>True if created successfully
        /// False otherwise</returns>
        public Boolean createChildObject(String childName, String filePath, String metadataKey,String metadataValue)
        {
        ...
        /// False otherwise</returns>
        public Boolean updateMetadata(String metadataKey, String metadataValue)
        {
            try
            {
                PutHTTPRequest request = new PutHTTPRequest(this.client);
